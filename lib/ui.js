function UI(game, board_sel, infos_sel, places_sel) {
  this.game = game;
  this.board_sel = board_sel;
  this.infos_sel = infos_sel;
  this.places_sel = places_sel;
...
UI.prototype.$board = function() {
  return $(this.board_sel);
};

UI.prototype.$places = function() {
  return this.$board().children(this.places_sel);
};
