...
Player.prototype.can_capture = function() {
  return _.any(this.game.other_player(this).pieces_on_board(), function(piece) {
...
Player.prototype.place_piece = function(place) { // first stage
